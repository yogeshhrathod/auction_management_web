...
import init from "../../common/repository/initProfile";
  const PATH = "/profile/";
...
function UserProfile(props) {
  ...
  useEffect(() => {
    const initProfile = async () => {
      ...
      const response = await init(id?id:localStorage.getItem("userId"));
      const body = await response.json();
      setName(body.name);
      setBio(body.bio);
      setEmail(body.email);
      setProfilePic(body.profilePic);
      if(props.match.path==="/user-profile/")
        setisOwner(true);
    };
    initProfile();
  }, []);
  ...
  if (bio === "") setBio("Hey your bio here...");
  return (
    <div className="container">
      <div className="box">
        ...
        <div className="bio">
          ...
          <button className={`edit-profile-button ${isOwner? "show-b":"hide"}`} onClick={gotoEdit}>
            Edit Profile
          </button>
